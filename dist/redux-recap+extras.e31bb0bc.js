...
},{"symbol-observable":"node_modules/symbol-observable/es/index.js"}],"node_modules/redux-logger/dist/redux-logger.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
// TYPES
const ADD = "ADD";
const REMOVE = "REMOVE"; //INITIAL STATE
...
const counterReducer = (state = initialState, {
  ...
  switch (type) {
    ...
    case REMOVE:
      return { ...state,
        vrienden: state.vrienden.filter(vriend => vriend.id != payload)
      };
...
exports.default = _default;
},{"uuid":"node_modules/uuid/dist/esm-browser/index.js"}],"redux/counter.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.setValue = exports.decrement = exports.increment = void 0;
// TYPES
const INCREMENT = "INCREMENT";
const DECREMENT = "DECREMENT";
const SET_VALUE = "SET_VALUE"; //INITIAL STATE
...
var _default = counterReducer;
exports.default = _default;
},{}],"redux/person.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.setAge = exports.setName = void 0;
// TYPES
const SET_NAME = "SET_NAME";
const SET_AGE = "SET_AGE"; //INITIAL STATE
...
const personReducer = (state = initialState, {
  type,
  payload
}) => {
  switch (type) {
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"redux/movies.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.getMovies = void 0;
...
const MOVIE_FETCH_FAIL = "MOVIE_FETCH_FAIL"; // ACTIONCREATORS

const movieFetchStart = str => ({
  type: MOVIE_FETCH_START,
  payload: str
});

const movieFetchFail = () => ({
  type: MOVIE_FETCH_FAIL
});

const movieFetchSuccess = movies => ({
  type: MOVIE_FETCH_SUCCESS,
  payload: movies
});

const getMovies = str => async (dispatch, getState) => {
  //movie saven en loading true
  dispatch(movieFetchStart(str));

  try {
    const response = await (0, _axios.default)(`https://api.themoviedb.org/3/search/movie?api_key=10fa74251cfff94026cb589d95b3db91&language=en-US&query=${getState().movieState.movie}&page=1&include_adult=false`);
    dispatch(movieFetchSuccess(response.data.results));
  } catch (error) {
    dispatch(moveFetchFail());
  }
}; // REDUCER
...
exports.default = _default;
},{"axios":"node_modules/axios/index.js"}],"node_modules/redux-devtools-extension/index.js":[function(require,module,exports) {
"use strict";
...
var _klasvrienden = _interopRequireDefault(require("./klasvrienden"));
...
const rootReducer = redux.combineReducers({
  counterState: _counter.default,
  vriendenState: _klasvrienden.default,
  personState: _person.default,
  movieState: _movies.default
});
const store = redux.createStore(rootReducer, (0, _reduxDevtoolsExtension.composeWithDevTools)(redux.applyMiddleware(_reduxLogger.default, _reduxThunk.default)));
var _default = store;
exports.default = _default;
},{"redux":"node_modules/redux/es/redux.js","redux-logger":"node_modules/redux-logger/dist/redux-logger.js","redux-thunk":"node_modules/redux-thunk/es/index.js","./klasvrienden":"redux/klasvrienden.js","./counter":"redux/counter.js","./person":"redux/person.js","./movies":"redux/movies.js","redux-devtools-extension":"node_modules/redux-devtools-extension/index.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _klasvrienden = require("./redux/klasvrienden");

var _person = require("./redux/person");

var _movies = require("./redux/movies");
...
function updateCounterValue() {
  const {
    counter
  } = _store.default.getState().counterState; //extracting child as var from object = ES6 object destructuring
...
updateCounterValue(); //ELKE KEER DAT DE STORE AANGEPAST WORDT

_store.default.subscribe(updateCounterValue); //UISTUREN VAN ACTION OM ZO ONRECHTSTREEKS DATA TE MANIPULEREN


document.getElementById("inc").onclick = () => _store.default.dispatch((0, _counter.increment)());

document.getElementById("dec").onclick = () => _store.default.dispatch((0, _counter.decrement)());
...
function renderfriends() {
  document.getElementById("vrienden").innerHTML = _store.default.getState().vriendenState.vrienden.map(vriendObj => `<li data-id="${vriendObj.id}">${vriendObj.name} (${vriendObj.id})</li>`).join("");
}

renderfriends();

_store.default.subscribe(renderfriends);

document.getElementById("friendForm").onsubmit = e => {
  e.preventDefault();

  _store.default.dispatch((0, _klasvrienden.add)(document.querySelector("#friendForm input").value));

  document.querySelector("#friendForm input").value = "";
};

document.getElementById("vrienden").onclick = e => {
  if (e.target.nodeName === "LI") {
    _store.default.dispatch((0, _klasvrienden.remove)(e.target.dataset.id));
  }
};
/**
 * PERSONZONE
...
function renderPerson() {
  const {
    age,
    name
  } = _store.default.getState().personState;
...
_store.default.subscribe(renderPerson);

document.getElementById("namefield").oninput = e => _store.default.dispatch((0, _person.setName)(e.target.value));

document.getElementById("agefield").oninput = e => _store.default.dispatch((0, _person.setAge)(parseInt(e.target.value)));
/**
 * MOVIEZONE
 */
...
document.getElementById("movieform").onsubmit = e => {
  ...
  _store.default.dispatch((0, _movies.getMovies)(document.querySelector("#movieform input").value));
...
function movieRender() {
  const {
    ...
    loading,
    movies
  } = _store.default.getState().movieState;

  document.getElementById("titel").innerText = movie;
  ...
  if (movies) {
    document.getElementById("moviegrid").innerHTML = movies.map(movie => `<li>${movie.title}</li>`).join("");
  } else {
...
_store.default.subscribe(movieRender);
},{"./redux/store":"redux/store.js","./redux/counter":"redux/counter.js","./redux/klasvrienden":"redux/klasvrienden.js","./redux/person":"redux/person.js","./redux/movies":"redux/movies.js"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/redux-recap+extras.e31bb0bc.js.map